...
?>
  ...
  <div style="width:30%;float:left;min-height:500px;display:table;text-align:center;padding:20px 30px;">
    <div style="vertical-align:middle;min-height:480px;color:white;font-size:46px;font-weight:bolder;border-right:solid black 3px;">
      <p class="headcolor" style="color:black;">INTERNSHIP</p>
    </div>
  </div>
